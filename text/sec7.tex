...
\section*{\color{Blue}{Conclusioni}}% (fold)
\label{sec:conclusion}
\addcontentsline{toc}{section}{Conclusioni}
\pdfbookmark[21]{Conclusioni}{conclusion}
...
\section*{\color{Blue}{Ringraziamenti}}% (fold)
\label{sec:acknowledgements}
\addcontentsline{toc}{section}{Ringraziamenti}
\pdfbookmark[22]{Ringraziamenti}{acknowledgements}

\subsection*{\color{SteelBlue}{Persone}}% (fold)
\label{sec:people}
\addcontentsline{toc}{subsection}{Persone}
\pdfbookmark[23]{Persone}{people}
...
\subsection*{\color{SteelBlue}{Storia}}% (fold)
\label{sec:history}
\addcontentsline{toc}{subsection}{Storia}
\pdfbookmark[24]{Storia}{history}
...
\newpage
\section*{\color{Blue}{Revisioni}}% (fold)
\label{sec:revisions}
...
\end{enumerate}
%% section revisions (end)

\newpage
\section*{\color{Blue}{Traduzione}}% (fold)
...
\subsection*{\color{SteelBlue}{Note alla versione italiana}}% (fold)
