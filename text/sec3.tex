...
\subsubsection*{Dimensioni del Team di Sviluppo} % (fold)
...
\subsubsection*{Servizio dello Scrum Master per il Product Owner} % (fold)
...
\subsubsection*{Servizio dello Scrum Master per il Team Scrum} % (fold)
...
\subsubsection*{Servizio dello Scrum Master per l'Organizzazione} % (fold)
